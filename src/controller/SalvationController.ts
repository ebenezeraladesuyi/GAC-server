...
import salvationModel from "../model/SalvationModel";

export const salvationMessage = () => {

}


export const sendSalvationMessage = async (req: Request, res: Response): Promise<void> => {
    try {
        // extract date from req.body
        const { name, email, phoneNumber, prayer } = req.body;

        // save message to mongoDB
        const contactSalvation = await salvationModel.create({ name, email, phoneNumber, prayer});
